...
class _SettingsPageState extends State<SettingsPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // --- قسم تخصيص المظهر (الزر الحركي الجديد) ---
  ...
  // --- بناء الزر الحركي المخصص (الشمس والقمر) ---
              ...
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isDark ? const Color(0xFF2E335A) : Colors.blue.shade100,
                  ),
                  child: Stack(
                    children: [
                      AnimatedPositioned(
                        ...
                        child: AnimatedRotation(
                          ...
                          child: Container(
                            ...
                            child: Icon(
                              ...
                              size: 18,
                              color: isDark ? const Color(0xFF2E335A) : Colors.white,
                            ),
                          ),
                        ),
                      ),
  ...
  Widget _buildDivider() {
    return Divider(height: 1, thickness: 1, color: Colors.grey.withOpacity(0.05), indent: 64);
  }
